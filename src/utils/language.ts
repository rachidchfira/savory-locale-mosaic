...
export const translations = {
  en: {
    ...
    address: "Address",
    addressText: "No. 429, Section 1, Taiwan Boulevard, Central District, Taichung City, Taiwan 400",
    phone: "Phone",
    openingHours: "Opening Hours",
    weekdays: "Working Days: 10:30 AM - 1:30 PM and 5:20 PM - 8:00 PM",
    weekends: "Wednesday Closed",
  ...
  zhTW: {
    ...
    address: "地址",
    addressText: "台灣大道中區一段429號",
    phone: "電話",
    openingHours: "營業時間",
    weekdays: "營業日：上午10:30 - 下午1:30，下午5:20 - 晚上8:00",
    weekends: "週三公休",
  ...
  vi: {
    ...
    address: "Địa chỉ",
    addressText: "Số 429, Đoạn 1, Đại lộ Đài Loan, Quận Trung tâm, Thành phố Taichung, Đài Loan 400",
    phone: "Điện thoại",
    openingHours: "Giờ Mở Cửa",
    weekdays: "Ngày làm việc: 10:30 - 13:30 và 17:20 - 20:00",
    weekends: "Nghỉ thứ Tư",
