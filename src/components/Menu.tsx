...
const Menu: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { img: menuImages.bunThitNuong, title: t.bunThitNuong, desc: t.bunThitNuongDesc, price: 110 },
    ...
    { img: menuImages.goiCuon, title: t.goiCuon, desc: t.goiCuonDesc, price: 120 },
    { img: menuImages.bunMangVit, title: t.bunMangVit, desc: t.bunMangVitDesc, price: 120 },
    { img: menuImages.vietnameseCoffee, title: t.caPheSua, desc: t.caPheSuaDesc, price: 60 }
  ];
